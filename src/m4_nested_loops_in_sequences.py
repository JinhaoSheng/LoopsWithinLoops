...
def run_test_sum_numbers():
    ...
    # Test 3:
    expected = 10336
    answer = sum_numbers([(3, 1, 4, 7, 10291), (10, 10), [1, 2, 3, 4]])
    print('Expected and actual are:', expected, answer)

    # Test 4:
    expected = 0
    answer = sum_numbers([(3, 1, 4), (10, 10, -38), [1, 2, 3, 4]])
    print('Expected and actual are:', expected, answer)

    # Test 5:
    expected = 6
    answer = sum_numbers([(3, 1, 4), (10, 10), [1, 2, 3, 4], [21, 29, -82]])
    print('Expected and actual are:', expected, answer)
